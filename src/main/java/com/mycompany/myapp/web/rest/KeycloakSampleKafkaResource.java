...
@RestController
@RequestMapping("/api/keycloak-sample-kafka")
public class KeycloakSampleKafkaResource {
    private final Logger log = LoggerFactory.getLogger(KeycloakSampleKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public KeycloakSampleKafkaResource(KafkaProperties kafkaProperties) {
