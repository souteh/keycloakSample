...
/**
 * Criteria class for the {@link com.mycompany.myapp.domain.Etape} entity. This class is used
 * in {@link com.mycompany.myapp.web.rest.EtapeResource} to receive all the possible filtering options from
