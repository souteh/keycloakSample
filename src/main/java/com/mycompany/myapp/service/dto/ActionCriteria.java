...
/**
 * Criteria class for the {@link com.mycompany.myapp.domain.Action} entity. This class is used
 * in {@link com.mycompany.myapp.web.rest.ActionResource} to receive all the possible filtering options from
