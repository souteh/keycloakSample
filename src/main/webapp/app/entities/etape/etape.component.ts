...
export class EtapeComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.etapeService
      ...
      .subscribe(
        (res: HttpResponse<IEtape[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInEtapes(): void {
    this.eventSubscriber = this.eventManager.subscribe('etapeListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IEtape[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
