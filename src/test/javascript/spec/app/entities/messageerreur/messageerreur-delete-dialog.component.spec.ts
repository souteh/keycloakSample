...
import { MessageerreurDeleteDialogComponent } from 'app/entities/messageerreur/messageerreur-delete-dialog.component';
  ...
  describe('Messageerreur Management Delete Component', () => {
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        declarations: [MessageerreurDeleteDialogComponent],
      })
