...
import { TfjComponent } from 'app/entities/tfj/tfj.component';
import { TfjService } from 'app/entities/tfj/tfj.service';
import { Tfj } from 'app/shared/model/tfj.model';

describe('Component Tests', () => {
  describe('Tfj Management Component', () => {
    let comp: TfjComponent;
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.tfjs && comp.tfjs[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
