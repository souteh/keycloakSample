...
import com.mycompany.myapp.service.dto.EtapeparamCriteria;
import com.mycompany.myapp.service.EtapeparamQueryService;
...
public class EtapeparamResourceIT {
    ...
    public void createEtapeparam() throws Exception {
        ...
        restEtapeparamMockMvc.perform(post("/api/etapeparams").with(csrf())
    ...
    public void updateEtapeparam() throws Exception {
        ...
        restEtapeparamMockMvc.perform(put("/api/etapeparams").with(csrf())
            .contentType(MediaType.APPLICATION_JSON)
    ...
    public void deleteEtapeparam() throws Exception {
        ...
        restEtapeparamMockMvc.perform(delete("/api/etapeparams/{id}", etapeparam.getId()).with(csrf())
