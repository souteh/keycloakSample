...
import com.mycompany.myapp.service.dto.StatutenumCriteria;
import com.mycompany.myapp.service.StatutenumQueryService;
...
public class StatutenumResourceIT {
    ...
    public void createStatutenum() throws Exception {
        ...
        restStatutenumMockMvc.perform(post("/api/statutenums").with(csrf())
    ...
    public void updateStatutenum() throws Exception {
        ...
        restStatutenumMockMvc.perform(put("/api/statutenums").with(csrf())
            .contentType(MediaType.APPLICATION_JSON)
    ...
    public void deleteStatutenum() throws Exception {
        ...
        restStatutenumMockMvc.perform(delete("/api/statutenums/{id}", statutenum.getId()).with(csrf())
