...
import com.mycompany.myapp.KeycloakSampleApp;
...
import com.mycompany.myapp.service.dto.MessageerreurCriteria;
import com.mycompany.myapp.service.MessageerreurQueryService;
 ...
 */
@SpringBootTest(classes = { KeycloakSampleApp.class, TestSecurityConfiguration.class })
...
public class MessageerreurResourceIT {
    ...
    public void createMessageerreur() throws Exception {
        ...
        restMessageerreurMockMvc.perform(post("/api/messageerreurs").with(csrf())
    ...
    public void updateMessageerreur() throws Exception {
        ...
        restMessageerreurMockMvc.perform(put("/api/messageerreurs").with(csrf())
            .contentType(MediaType.APPLICATION_JSON)
    ...
    public void deleteMessageerreur() throws Exception {
        ...
        restMessageerreurMockMvc.perform(delete("/api/messageerreurs/{id}", messageerreur.getId()).with(csrf())
