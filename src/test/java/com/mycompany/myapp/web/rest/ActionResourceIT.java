...
import com.mycompany.myapp.service.dto.ActionCriteria;
import com.mycompany.myapp.service.ActionQueryService;
...
public class ActionResourceIT {
    ...
    public void createAction() throws Exception {
        ...
        // Create the Action
        restActionMockMvc.perform(post("/api/actions").with(csrf())
    ...
    public void updateAction() throws Exception {
        ...
        restActionMockMvc.perform(put("/api/actions").with(csrf())
            .contentType(MediaType.APPLICATION_JSON)
    ...
    public void deleteAction() throws Exception {
        ...
        // Delete the action
        restActionMockMvc.perform(delete("/api/actions/{id}", action.getId()).with(csrf())
