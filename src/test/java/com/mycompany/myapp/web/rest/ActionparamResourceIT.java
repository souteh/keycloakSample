...
import com.mycompany.myapp.service.dto.ActionparamCriteria;
import com.mycompany.myapp.service.ActionparamQueryService;
...
public class ActionparamResourceIT {
    ...
    public void createActionparam() throws Exception {
        ...
        restActionparamMockMvc.perform(post("/api/actionparams").with(csrf())
    ...
    public void updateActionparam() throws Exception {
        ...
        restActionparamMockMvc.perform(put("/api/actionparams").with(csrf())
            .contentType(MediaType.APPLICATION_JSON)
    ...
    public void deleteActionparam() throws Exception {
        ...
        restActionparamMockMvc.perform(delete("/api/actionparams/{id}", actionparam.getId()).with(csrf())
