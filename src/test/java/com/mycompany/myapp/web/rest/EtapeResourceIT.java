...
import com.mycompany.myapp.service.dto.EtapeCriteria;
import com.mycompany.myapp.service.EtapeQueryService;
...
public class EtapeResourceIT {
    ...
    public void createEtape() throws Exception {
        ...
        // Create the Etape
        restEtapeMockMvc.perform(post("/api/etapes").with(csrf())
    ...
    public void updateEtape() throws Exception {
        ...
        restEtapeMockMvc.perform(put("/api/etapes").with(csrf())
            .contentType(MediaType.APPLICATION_JSON)
    ...
    public void deleteEtape() throws Exception {
        ...
        // Delete the etape
        restEtapeMockMvc.perform(delete("/api/etapes/{id}", etape.getId()).with(csrf())
