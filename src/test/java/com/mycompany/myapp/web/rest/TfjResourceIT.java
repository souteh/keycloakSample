...
public class TfjResourceIT {
    ...
    public void createTfj() throws Exception {
        ...
        // Create the Tfj
        restTfjMockMvc.perform(post("/api/tfjs").with(csrf())
    ...
    public void updateTfj() throws Exception {
        ...
        restTfjMockMvc.perform(put("/api/tfjs").with(csrf())
            .contentType(MediaType.APPLICATION_JSON)
    ...
    public void deleteTfj() throws Exception {
        ...
        // Delete the tfj
        restTfjMockMvc.perform(delete("/api/tfjs/{id}", tfj.getId()).with(csrf())
